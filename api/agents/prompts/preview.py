...
2. **Sample body** when appropriate: e.g. part or all of the first outline chapter, another representative slice, or further intro — use the chapter title as a markdown heading (e.g. ## Chapter 1: Title) when you include a distinct chapter-like section. Match tone and audience.
