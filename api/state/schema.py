...
class BookSpecification(BaseModel):
    ...
    target_length_pages: int = Field(..., ge=150, le=250, description="Target length in pages")
...
class IntakeBookSpecification(BaseModel):
    ...
    target_length_pages: Optional[int] = Field(None, ge=150, le=250, description="Target length in pages")
...
class BookOutline(BaseModel):
    ...
    estimated_pages: int = Field(..., ge=150, le=250)
